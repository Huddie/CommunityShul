...
const EnhancedTable = ({
  ...
  const deleteShiurHandler = event => {
  ...
  const addShiurHandler = shiur => {
    const newData = data.concat([shiur])
    setData(newData)
    updateMyData(shiur)
  }
  ...
  return (
    <TableContainer>
      <TableToolbar
        ...
        // deleteUserHandler={deleteShiurHandler}
        addShiurHandler={addShiurHandler}
